...
export default class DataSelector extends Component {
    constructor(props) {
        ...
        if (selectedDatabase && !hasMultipleSchemas && steps.includes(SCHEMA_STEP)) {
            console.log(selectedDatabase, hasMultipleSchemas, _.uniq(selectedDatabase.tables, (t) => t.schema))
...
export const SchemaPicker = ({ selectedDatabase, selectedSchema, onChangeSchema }) => {
    let sections = [{
